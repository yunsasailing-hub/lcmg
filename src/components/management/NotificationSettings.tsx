...
export default function NotificationSettingsPanel() {
  ...
  if (isLoading) {
    return (
      <div className="p-6 text-center text-sm text-muted-foreground">Loading settings...</div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="stat-card p-0 overflow-hidden">
        <div className="flex items-center gap-2 px-5 pt-5 pb-3">
          ...
          <h3 className="text-sm font-heading font-semibold text-foreground">In-App Checklist Notifications</h3>
        </div>
        ...
        <div className="px-5 pb-5 space-y-5">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-sm font-medium">Checklist Notices</Label>
                <p className="text-xs text-muted-foreground mt-0.5">
                  Send a notice to staff when a checklist is overdue
                </p>
              </div>
            ...
            {noticesEnabled && (
              <div className="flex items-center gap-3 pl-4 border-l-2 border-warning/30">
                ...
                />
                <span className="text-xs text-muted-foreground">hours after due time</span>
              </div>
            )}
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <Label className="text-sm font-medium">Checklist Warnings & Escalations</Label>
                <p className="text-xs text-muted-foreground mt-0.5">
                  Send a warning to staff and escalation to their manager
                </p>
              </div>
      ...
      <div className="stat-card p-0 overflow-hidden opacity-60">
        <div className="flex items-center gap-2 px-5 pt-5 pb-3">
          ...
          <h3 className="text-sm font-heading font-semibold text-muted-foreground">Additional Channels</h3>
        ...
        <div className="px-5 pb-5 space-y-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Browser & mobile push alerts</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <Label className="text-sm text-muted-foreground">WhatsApp Notifications</Label>
              <p className="text-xs text-muted-foreground mt-0.5">Send alerts via WhatsApp</p>
            </div>
            <Switch disabled checked={false} />
          </div>
        </div>
